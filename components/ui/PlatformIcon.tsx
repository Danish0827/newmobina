...
export function PlatformIcon({ platform, className, variant = "app" }: PlatformIconProps) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="pi-ig" x1="0" y1="1" x2="1" y2="0">
        ...
        <linearGradient id="pi-yt" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#FF4A4A" />
          <stop offset="100%" stopColor="#D80F0F" />
        </linearGradient>
        <linearGradient id="pi-li" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#3B9BE0" />
          <stop offset="100%" stopColor="#0A66C2" />
        </linearGradient>
        <linearGradient id="pi-fb" x1="0" y1="0" x2="0" y2="1">
      ...
      {platform === "youtube" ? (
        <>
          {rounded ? <rect width="64" height="64" rx="16" fill="url(#pi-yt)" /> : null}
          {!rounded ? <rect y="12" width="64" height="40" rx="11" fill="url(#pi-yt)" /> : null}
      ...
      {platform === "instagram" ? (
        <>
          <rect width="64" height="64" rx="16" fill="url(#pi-ig)" />
          <rect
            x="15"
            y="15"
            width="34"
      ...
      {platform === "linkedin" ? (
        <>
          <rect width="64" height="64" rx="16" fill="url(#pi-li)" />
      ...
      {platform === "facebook" ? (
        <>
          <rect width="64" height="64" rx="16" fill="url(#pi-fb)" />
          <path
